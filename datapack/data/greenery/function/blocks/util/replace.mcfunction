...
execute as @e[type=item_display,tag=greenery.new_block,limit=1,sort=nearest] run function greenery:blocks/util/add_tag with block ~ ~ ~ Items[0].components.minecraft:custom_data
...
execute as @e[type=item_display,tag=greenery.wide_flower_pot,tag=greenery.new_block,limit=1,sort=nearest] run summon interaction ~ ~-0.5 ~ {Tags:["greenery.block","greenery.new_block"],height:0.371,width:0.6}
execute as @e[type=item_display,tag=greenery.wide_flower_pot,tag=greenery.new_block,limit=1,sort=nearest] run summon marker ~ ~ ~ {Tags:["greenery.block","greenery.new_block"]}
execute as @e[type=item_display,tag=greenery.wide_flower_pot,tag=greenery.new_block,limit=1,sort=nearest] run data merge entity @s {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.001f,1.001f,1.001f]}}
execute as @e[type=item_display,tag=greenery.beehive,tag=greenery.new_block,limit=1,sort=nearest] run tp @s ~ ~0.5 ~
execute as @e[type=item_display,tag=greenery.beehive,tag=greenery.new_block,limit=1,sort=nearest] run data merge entity @s {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.5f,0f],scale:[1.001f,1.001f,1.001f]}}
...
execute as @e[type=interaction,tag=greenery.new_block,limit=1,sort=nearest] run function greenery:blocks/util/add_tag with block ~ ~ ~ Items[0].components.minecraft:custom_data
execute as @e[type=marker,tag=greenery.new_block,limit=1,sort=nearest] run function greenery:blocks/util/add_tag with block ~ ~ ~ Items[0].components.minecraft:custom_data
...
execute as @e[type=item_display,tag=greenery.wide_flower_pot,tag=greenery.new_block,limit=1,sort=nearest] run setblock ~ ~ ~ oak_button[face=floor]

execute as @e[type=item_display,tag=greenery.hanging_flower_pot,tag=greenery.new_block,limit=1,sort=nearest] store result score @s greenery.cmd run data get entity @s item.components.custom_model_data
...
execute as @e[type=item_display,tag=greenery.hanging_flower_pot,tag=greenery.new_block,limit=1,sort=nearest] store result entity @s item.components.custom_model_data int 1 run scoreboard players get @s greenery.cmd
