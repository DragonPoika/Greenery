...
summon item_display ~ ~ ~ {Tags:["greenery.fishnet_display"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:cookie",Count:1b,tag:{CustomModelData:795005}}}
...
setblock ~ ~ ~ barrier[waterlogged=true]
